...
class th08_bullet_process_hook : public th_hook
{
	static th08_bullet_process_hook *instance;
public:
	th08_bullet_process_hook(th08_player *player) : th_hook(player) {}

	static void bind(th08_player *player);
	static th08_bullet_process_hook *inst();
